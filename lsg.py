...
\x1b[1;92m░╚════╝░╚═╝░░╚═╝╚═╝░░░░░╚═╝
\033[1;97m=======================================
\033[1;91mOwNeR  \033[1;93m: \033[1;94mTipu X Ahmad
\033[1;91mYouTube \033[1;93m: \033[1;94mTipu Sultan Official
\033[1;91mGitHub  \033[1;93m: \033[1;94mhttps://github.com/TipuSultan0076
\033[1;97m=======================================""")

def yayanxd():
    yayan=input("\n\033[00m\t   [\033[96m Press Enter To Return\033[97m ] ")
    if yayan == "": 
       os.system("python Lsg.py")
    else:
       sys.exit("\n\033[1;97m [\033[1;91m•\033[1;97m] \033[1;91mGood Byee :')")
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start  Cloning ID")
    print("\033[97m [\033[96m02\033[97m] Tutor  How to Get Fb Cookies")
    print("\033[97m [\033[96m03\033[97m] Joined Grup Fb")
